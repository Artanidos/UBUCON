...
#define ENGINESDIR "/media/art/data/SourceCode/UBUCON/src/sysroot-android-32/lib/engines"
#define OPENSSLDIR "/media/art/data/SourceCode/UBUCON/src/sysroot-android-32/ssl"
#endif
#endif
