...
_pkg_config = {
    ...
    'py_version':         0x030703,
    'qt_framework':       0,
    'sip_bin':            '/media/art/data/SourceCode/UBUCON/src/sysroot-android-32/host/bin/sip',
    'sip_config_args':    '--bindir /media/art/data/SourceCode/UBUCON/src/sysroot-android-32/host/bin --incdir /media/art/data/SourceCode/UBUCON/src/sysroot-android-32/include/python3.7 --no-module',
