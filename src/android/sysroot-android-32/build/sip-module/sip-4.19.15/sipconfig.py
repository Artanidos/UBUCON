...
_pkg_config = {
    ...
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/media/art/data/SourceCode/UBUCON/src/sysroot-android-32/include/python3.7',
    'py_inc_dir':         '/media/art/data/SourceCode/UBUCON/src/sysroot-android-32/include/python3.7',
    'py_lib_dir':         '/media/art/data/SourceCode/UBUCON/src/sysroot-android-32/lib',
    'py_version':         0x030703,
    'qt_framework':       0,
    'sip_bin':            '/usr/bin/sip',
    'sip_config_args':    '--static --sysroot /media/art/data/SourceCode/UBUCON/src/sysroot-android-32 --no-pyi --no-tools --use-qmake --configuration sip-android-32.cfg --no-dist-info --sip-module PyQt5.sip',
    'sip_inc_dir':        '/media/art/data/SourceCode/UBUCON/src/sysroot-android-32/include/python3.7',
    'sip_module_dir':     '/media/art/data/SourceCode/UBUCON/src/sysroot-android-32/lib/python3.7/site-packages',
