...
#if PY_MAJOR_VERSION >= 3
    PyObject *sip_flags = PyUnicode_FromString("-n PyQt5.sip -t WS_X11 -t Qt_5_12_3 -x PyQt_Desktop_OpenGL -x PyQt_Printer -x PyQt_PrintDialog -x PyQt_PrintPreviewDialog -x PyQt_PrintPreviewWidget");
#else
    PyObject *sip_flags = PyString_FromString("-n PyQt5.sip -t WS_X11 -t Qt_5_12_3 -x PyQt_Desktop_OpenGL -x PyQt_Printer -x PyQt_PrintDialog -x PyQt_PrintPreviewDialog -x PyQt_PrintPreviewWidget");
#endif
